...
All published ports bind to `127.0.0.1`. The database and bucket are dedicated to this disposable PR-00 environment. `down -v` is the required cleanup command; do not reuse these volumes for durable data.
