...
test('gallery is self-contained and exposes the shooting-reference index and detail controls', async () => {
  ...
  assert.match(html, /gallery-search/)
  ...
  assert.match(html, /prototype-catalog-section/)
  assert.match(html, /catalog-item-list/)
  assert.match(html, /sort-mode/)
  assert.match(html, /推荐（参考资料完整度）/)
  ...
  assert.match(script, /goodsmile\.info/)
