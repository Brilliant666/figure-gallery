...
def validate_regressions(document: Mapping[str, Any]) -> None:
    ...
    exact_test_result(document.get("sqlite"), "SQLite regression", passed=44, skipped=8)
    exact_test_result(document.get("postgres_integration"), "PostgreSQL integration", passed=29)
...
def validate_restore_regressions(document: Mapping[str, Any]) -> None:
    ...
    exact_test_result(document.get("postgres_integration"), "restored PostgreSQL integration", passed=29)
